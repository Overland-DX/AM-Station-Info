...
var GeodesicGeometry = /** @class */ (function () {
    ...
    GeodesicGeometry.prototype.splitLine = function (startPosition, destPosition) {
        var antimeridianWest = {
            point: new L__namespace.LatLng(89.9, -180.0000001), // lng is slightly off, to detect intersections with lines starting exactly on the antimeridian
            bearing: 180
        };
...
function latlngExpressiontoLatLng(input) {
    if (input instanceof L__namespace.LatLng) {
        ...
        return new L__namespace.LatLng(input[0], input[1], input[2]); // alt is optional
    }
